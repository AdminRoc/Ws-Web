 ...
 * ──────────────────────────────────────────────────────── */
var eidolonMacroDuoNotice_cn = "玩家ID ‘吖吖酱 / V-PHOENIX’ 所提交的纪录，涉嫌使用AHK工具进行作弊，且该玩家在提交记录时故意欺瞒自身情况，根据本站的作弊处理原则，现将该记录标记为 [作弊]，并将该玩家提交的全部信息永久公示，点击榜单底部按钮即可查看。若该内容属于他人冒用号主身份进行上传的，号主本人可以提供相关证据，本站将对侵权内容进行及时处理。（纪录的上传、审核都是基于玩家主观善意的基础上的，部分玩家利用这一点，意图故意提交违规内容以示本站审核不严，希望他人不要效仿此人的无耻行为。请各位互相监督，及时对作弊者进行举报）";
