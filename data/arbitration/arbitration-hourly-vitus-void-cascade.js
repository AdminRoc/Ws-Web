 ...
 * ──────────────────────────────────────────────────────── */
var arbitration_hourly_vitus_void_cascadeNotice_cn = "  单小时的生息精华数量，将把当次任务结算时显示的生息精华数量，按任务的实际时长进行换算。此处的“任务实际时长”按“首尾帧”的方式计算，具体计算方式请参考“提交规则”内的“通用规则”文档。";
var arbitration_hourly_vitus_void_cascadeNotice_en = "  Vitus Essence per hour converts the Vitus Essence amount shown on the mission's end-of-mission screen according to the mission's actual duration. Here, the \"actual mission duration\" is measured using the first-and-last-frame method; for the exact calculation, please refer to the \"General Rules\" document under \"Submission Rules\".";
