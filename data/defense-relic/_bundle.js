...
/* ===== data/defense-relic/defense-relic-normal-akkad.js ===== */
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-akkad.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_akkadRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
...
var defense_relic_normal_akkadRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-belenus.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_belenusRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_belenusRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-casta.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_castaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_castaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-coba.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_cobaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_cobaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-gulliver.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_gulliverRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_gulliverRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-helene.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_heleneRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_heleneRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-hydron.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_hydronRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_hydronRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-io.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_ioRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_ioRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-kadesh.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_kadeshRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_kadeshRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-kala-azar.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_kala_azarRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_kala_azarRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-lares.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_laresRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_laresRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-larzac.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_larzacRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_larzacRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-lith.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_lithRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_lithRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-nabuk.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_nabukRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_nabukRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-outer.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_outerRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_outerRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-paimon.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_paimonRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_paimonRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-proteus.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_proteusRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_proteusRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-romula.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_romulaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_romulaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-sangeru.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_sangeruRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_sangeruRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-sechura.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_sechuraRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_sechuraRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-seimeni.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_seimeniRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_seimeniRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-sinai.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_sinaiRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_sinaiRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-spear.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_spearRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_spearRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-stephano.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_stephanoRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_stephanoRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-stofler.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_stoflerRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_stoflerRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-taranis.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_taranisRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_taranisRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-normal-tessera.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_normal_tesseraRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_normal_tesseraRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-akkad.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_akkadRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_akkadRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-belenus.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_belenusRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_belenusRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-casta.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_castaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_castaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-coba.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_cobaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_cobaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-gulliver.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_gulliverRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_gulliverRecords = [
  /* 暂无记录 */
];
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_heleneRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_heleneRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-hydron.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_hydronRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_hydronRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-hyf.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_hyfRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_hyfRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-io.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_ioRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_ioRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-kadesh.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_kadeshRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_kadeshRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-kala-azar.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_kala_azarRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_kala_azarRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-lares.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_laresRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_laresRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-larzac.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_larzacRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_larzacRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-lith.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_lithRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_lithRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-nabuk.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_nabukRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_nabukRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-outer.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_outerRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_outerRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-paimon.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_paimonRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_paimonRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-proteus.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_proteusRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_proteusRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-romula.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_romulaRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_romulaRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-sangeru.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_sangeruRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_sangeruRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-sechura.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_sechuraRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_sechuraRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-seimeni.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_seimeniRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_seimeniRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-sinai.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_sinaiRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_sinaiRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-spear.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_spearRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_spearRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-stephano.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_stephanoRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_stephanoRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-stofler.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_stoflerRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_stoflerRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-taranis.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_taranisRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_taranisRecords = [
  /* 暂无记录 */
];
...
/* ════════════════════════════════════════════════════════════
 *  防御裂缝78轮 竞速排行榜  /  Defense Relic 78 Rounds Speedrun Leaderboard
 *  数据文件：defense-relic-steel-tessera.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 defense_relic_steel_tesseraRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
...
var defense_relic_steel_tesseraRecords = [
  /* 暂无记录 */
];
