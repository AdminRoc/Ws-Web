...
/* ===== data/ropalolyst/ropalolyst-normal.js ===== */
/* ════════════════════════════════════════════════════════════
...
/* ===== data/ropalolyst/ropalolyst-steel.js ===== */
/* ════════════════════════════════════════════════════════════
 *  蝠力使 竞速排行榜  /  The Ropalolyst Speedrun Leaderboard
 *  数据文件：ropalolyst-steel.js
 *  ┌──────────────────────────────────────────────────────┐
 *  │  字段说明：                                          │
 *  │    playerId  —— 玩家 ID（昵称）                      │
 *  │    clearTime —— 时间（格式：mm:ss.ms）            │
 ...
 *
 *  添加/修改记录方法：
 *  在下方 ropalolyst_steelRecords 数组中新增一个对象，如：
 *    {
 *      playerId:   "玩家名",
 *      clearTime:  "1:23.456",
 *      uploadTime: "2025-01-01",
 ...
 * Notice_en : 鼠标停留时显示的英文提醒（可留空）
 * ──────────────────────────────────────────────────────── */
var ropalolyst_steelNotice_cn = "";
var ropalolyst_steelNotice_en = "";
;
