...
### 注意：近期上传的dmg模块是不完全的版本，此举是为防止某个神人的直接“搬运”，再反过来声明原创；虽然dmg模块已经早在5月就已经写好，但我还是决定等某人自己抄（实际上还是搬运“warframe-damage.com”，就别总说自己是原创了）完了再实装本站的dmg模块，此外，本站的用户实际上基本都不需要这类辅助计算工具，不像某些搬运专家，吃点大芬都要问问GPT能不能吃。
...
- 在 2026/5/20 之前，本站一直是建立在位于香港的云服务器上的，而后考虑到下列因素，决定转为开源，将代码库建立在GitHub端，并顺势使用Public库可以无限使用Action的特性，对世界状态等信息进行自动化调试。
