...
const GameData = {
  ...
  weaponList: [
    ...
    {
      "name": "Dakra Prime", "nameZh": "达克拉 Prime"
    },
    {
      "name": "Dera",
      "nameZh": "德拉"
    ...
    {
      "name": "Dex Dakra", "nameZh": "Dex 达克拉双剑"
    },
    {
      "name": "Dex Nikana", "nameZh": "Dex 侍刃"
    },
    {
      "name": "Destreza Prime",
      "nameZh": "技巧之剑Prime"
    ...
    {
      "name": "Euphona Prime", "nameZh": "悦音 Prime"
    },
    {
      "name": "Ether Daggers",
      "nameZh": "苍穹匕首"
    ...
    {
      "name": "Kuva Bramma", "nameZh": "赤毒·布拉玛"
    },
    {
      "name": "Kronsh (Polearm)",
      "nameZh": "客隆什 (长柄武器)"
    ...
    {
      "name": "Kuva Chakkhurr", "nameZh": "赤毒·邪眼"
    },
    {
      "name": "Kuva Drakgoon", "nameZh": "赤毒·龙骑兵"
    },
    {
      "name": "Kuva Hek", "nameZh": "赤毒·海克"
    },
    {
    ...
    {
      "name": "Kuva Hind", "nameZh": "赤毒·雌鹿"
    },
    {
      "name": "Kuva Karak", "nameZh": "赤毒·卡拉克"
    },
    {
    ...
    {
      "name": "Kuva Seer", "nameZh": "赤毒·预言者"
    },
    {
      "name": "Kuva Kraken", "nameZh": "赤毒·北海巨妖"
    },
    {
      "name": "Kuva Kohm", "nameZh": "赤毒·寇恩热能枪"
    },
    {
      "name": "Kuva Quartakk", "nameZh": "赤毒·夸塔克"
    },
    {
      "name": "Kuva Shildeg", "nameZh": "赤毒·希尔德"
    },
    {
      "name": "Kuva Nukor", "nameZh": "赤毒·努寇微波枪"
    },
    {
      "name": "Kuva Sobek",
      "nameZh": "赤毒·鳄神"
    ...
    {
      "name": "Kuva Ogris", "nameZh": "赤毒·食人女魔"
    },
    {
      "name": "Kuva Tonkor", "nameZh": "赤毒·征服榴炮"
    },
    {
      "name": "Kuva Twin Stubbas", "nameZh": "赤毒·双子史度巴"
    },
    {
      "name": "Laetum",
      "nameZh": "奏凯"
    ...
    {
      "name": "Reaper Prime", "nameZh": "收割者 Prime"
    },
    {
      "name": "Reconifex", "nameZh": "侦察者"
    },
    {
    ...
    {
      "name": "Sigma & Octantis", "nameZh": "西格玛 & 南极座"
    },
    {
      "name": "Sheev",
      "nameZh": "希芙"
    ...
    {
      "name": "Tenet Agendus", "nameZh": "信条·集议"
    },
    {
      "name": "Telos Boltor",
      "nameZh": "终极·螺钉步枪"
    ...
    {
      "name": "Tenet Arca Plasmor", "nameZh": "信条·弧电离子枪"
    },
    {
      "name": "Tenet Cycron", "nameZh": "信条·循环离子枪"
    },
    {
      "name": "Tenet Glaxion", "nameZh": "信条·冷冻光束步枪"
    },
    {
      "name": "Tenet Diplos", "nameZh": "信条·纵横双枪"
    },
    {
      "name": "Tenet Detron", "nameZh": "信条·德特昂"
    },
    {
      "name": "Tenet Exec", "nameZh": "信条·枢密"
    },
    {
      "name": "Tenet Envoy", "nameZh": "信条·典客"
    },
    {
      "name": "Tenet Ferrox",
      "nameZh": "信条铁晶磁轨炮"
    ...
    {
      "name": "Tenet Flux Rifle", "nameZh": "信条·通量步枪"
    },
    {
      "name": "Tenet Grigori", "nameZh": "信条·格里高利"
    },
    {
      "name": "Tetra",
      "nameZh": "特拉"
    ...
    {
      "name": "Tenet Spirex", "nameZh": "信条·斯派克斯"
    },
    {
      "name": "Tenet Plinx", "nameZh": "信条·漫射者"
    },
    {
      "name": "Tenet Tetra", "nameZh": "信条·特拉"
    },
    {
      "name": "Tenora",
      "nameZh": "双簧管"
    ...
    {
      "name": "Tenet Livia", "nameZh": "信条·莉薇娅"
    },
    {
      "name": "Tiberon Prime",
      "nameZh": "狂鲨Prime"
  ...
  "Daikyu Prime":{"masteryReq":15,"description":"Long believed lost, the mighty Daikyu Prime was the pride of many a Tenno Dojo. The strength demanded to draw it is repaid in added range and power.","noise":"Silent","releaseDate":"2025-05-21","ammoCapacity":72,"productCategory":"LongGuns","zoomProps":[[]],"category":"Primary","trigger":"Charge","type":"Rifle","magazineSize":1,"reloadTime":0.6,"multishot":1,"unique":{"crit_chance_weakp":2.5},"attacks":[{"name":"Quick Shot","punch_through":3,"speed":1,"crit_chance":40,"crit_mult":2.4,"status_chance":50,"shot_type":"Projectile","unique":{"force_procs":["impact"]},"damage":{"Impact":112.5,"Slash":112.5,"Puncture":150}},{"name":"Charged Shot","punch_through":3,"speed":1,"crit_chance":40,"crit_mult":2.4,"status_chance":50,"shot_type":"Projectile","unique":{"force_procs":["impact"]},"damage":{"Impact":225,"Slash":225,"Puncture":300},"charge_time":1}],"name":"Daikyu Prime","imageName":"DaikyuPrime.webp","tags":["Tenno"],"compTags":["PROJECTILE","DAIKYU"]},
  ...
  "Evensong":{"masteryReq":10,"description":"Counter the dread of battle with a song of praise. Enemies cannot hurt your allies while wounded by Evensong’s arrows. Kills with Evensong empower ally weapons with Multishot. Experience the true power of Jade's Ensemble when Evensong, Cantare, and Harmony sing together.","noise":"Silent","releaseDate":"2024-06-18","ammoCapacity":72,"productCategory":"LongGuns","category":"Primary","trigger":"Charge","type":"Rifle","magazineSize":1,"reloadTime":0.6,"multishot":1,"unique":{"WITH_COND":{"multishot":0.35,"crit_chance":0.35}},"attacks":[{"name":"Quick Shot","speed":1,"crit_chance":25,"crit_mult":2.2,"status_chance":38,"shot_type":"Projectile","shot_speed":85,"damage":{"Slash":227.5,"Puncture":97.5}},{"name":"Charged Shot","punch_through":2.5,"speed":1,"crit_chance":25,"crit_mult":2.2,"status_chance":38,"shot_type":"Projectile","shot_speed":100,"damage":{"Slash":350,"Puncture":150},"charge_time":1.2},{"name":"Charged Radial Attack","speed":1,"crit_chance":25,"crit_mult":2.2,"status_chance":38,"shot_type":"Projectile","damage":{"Puncture":45,"Slash":105},"charge_time":1.2}],"name":"Evensong","imageName":"Evensong.webp","tags":[],"compTags":["PROJECTILE"],"comb":[[1,2]]},
  ...
  "Sagek Prime":{"masteryReq":14,"description":"The sidearm of choice for Prime Grineer warriors, Sagek Prime blends Grineer brutality with Orokin aesthetics. When Sagek Prime inflicts a critical hit, its next shot has a chance to gain significant Status Chance.","noise":"Alarming","releaseDate":"2025-12-10","ammoCapacity":450,"productCategory":"Pistols","zoomProps":[[]],"category":"Secondary","trigger":"Auto","type":"Pistol","magazineSize":75,"reloadTime":1.6,"multishot":1,"unique":{"sagekPassive":6},"attacks":[{"name":"Normal Attack","speed":12.33,"crit_chance":30,"crit_mult":2.2,"status_chance":1,"shot_type":"Hit-Scan","unique":{"ammoEff":0.2},"damage":{"Impact":6.112,"Slash":11.642,"Puncture":8.246}}],"name":"Sagek Prime","imageName":"SagekPrime.webp","tags":[],"compTags":[]},
  ...
  // === MOD 中文名映射 ===
  MOD_NAMES_ZH: {"Serration":"膛线","Amalgam Serration":"并合膛线","Spectral Serration":"幽灵 膛线","Higasa Serration":"晴日伞 膛线","Semi-Rifle Cannonade":"半自动步枪炮轰","Hornet Strike":"黄蜂螫刺","Augur Pact":"预言 契约","Magnum Force":"重装火力","Semi-Pistol Cannonade":"半自动手枪炮轰","Heavy Caliber":"重口径","Primary Acuity":"敏锐主武","Pistol Acuity":"敏锐手枪","Galvanized Aptitude":"镀层 步枪才能","Galvanized Shot":"镀层 准确射手","Galvanized Savvy":"镀层 通晓霰弹枪","Point Blank":"抵近射击","Primed Point Blank":"抵近射击 Prime","Semi-Shotgun Cannonade":"半自动霰弹枪炮轰","Pressure Point":"压迫点","Primed Pressure Point":"压迫点 Prime","Sacrificial Pressure":"牺牲压迫点","Condition Overload":"异况超量","Spoiled Strike":"腐坏打击","Vicious Spread":"恶性扩散","Galvanized Elementalist":"镀层 元素师","Melee Elementalist":"近战元素师","Rifle Elementalist":"步枪元素师","Pistol Elementalist":"手枪元素师","Shotgun Elementalist":"霰弹枪元素师","Stormbringer":"暴风使者","Cryo Rounds":"低温弹头","Primed Cryo Rounds":"低温弹头 Prime","Hellfire":"地狱火","Infected Clip":"污染弹匣","Malignant Force":"致命火力","Rime Rounds":"白霜弹头","Thermite Rounds":"铝热焊弹","Wildfire":"野火","High Voltage":"高压电流","Pathogen Rounds":"病原弹头","Heated Charge":"火焰装填","Primed Heated Charge":"火焰装填 Prime","Deep Freeze":"深层冷冻","Convulsion":"痉挛","Primed Convulsion":"痉挛 Prime","Fever Strike":"热病打击","Primed Fever Strike":"热病打击 Prime","Virulent Scourge":"剧毒灾害","North Wind":"北风","Vicious Frost":"蚀骨寒霜","Molten Impact":"熔岩冲击","Volcanic Edge":"爆裂刀刃","Shocking Touch":"电击触点","Voltaic Strike":"伏打电能","Focus Energy":"聚焦能量","Point Strike":"致命一击","Vital Sense":"弱点感应","Critical Delay":"关键延迟","Pistol Gambit":"手枪精通","Primed Pistol Gambit":"手枪精通 Prime","Target Cracker":"弱点专精","Primed Target Cracker":"弱点专精 Prime","Hollow Point":"空尖弹","Galvanized Steel":"镀层 斩铁","Proton Jet":"质子 喷射","Blunderbuss":"雷筒","Critical Deceleration":"降速暴击","Creeping Bullseye":"匍匐靶心","Argon Scope":"氩晶瞄具","Galvanized Scope":"镀层 氩晶瞄具","Hydraulic Crosshairs":"液压准心","Galvanized Crosshairs":"镀层 液压准心","Blood Rush":"急进猛突","Maiming Strike":"致残突击","Hammer Shot":"重锤射击","Melee Prowess":"非凡技巧","Weeping Wounds":"创口溃烂","Organ Shatter":"肢解","Amalgam Organ Shatter":"并合肢解","Gladiator Might":"角斗士 威猛","Gladiator Vice":"角斗士 钳制","Gladiator Rush":"角斗士 猛突","True Steel":"斩铁","Sacrificial Steel":"牺牲斩铁","Split Chamber":"分裂膛室","Galvanized Chamber":"镀层 分裂膛室","Galvanized Diffusion":"镀层 弹头扩散","Galvanized Hell":"镀层 地狱弹膛","Hell's Chamber":"地狱弹膛","Barrel Diffusion":"弹头扩散","Amalgam Barrel Diffusion":"并合弹头扩散","Split Flights":"分裂飞行","Vigilante Armaments":"私法 军备","Speed Trigger":"灵敏扳机","Vile Acceleration":"卑劣加速","Frail Momentum":"虚弱动能","Gunslinger":"神枪手","Anemic Agility":"乏能迅敏","Vile Precision":"极恶精准","Pressurized Magazine":"增压弹匣","Vigilante Fervor":"私法 热诚","Primed Shred":"撕裂 Prime","Shred":"撕裂","Berserker Fury":"嗜血 狂暴","Fury":"狂暴","Primed Fury":"狂暴 Prime","Quickening":"加速","Rifle Aptitude":"步枪才能","Sure Shot":"准确射手","Bladed Rounds":"尖刃弹头","Primed Reach":"剑风 Prime","Reach":"剑风","Hunter Munitions":"猎人 战备","Internal Bleeding":"内部出血","Hemorrhage":"失血","Lethal Torrent":"致命洪流","Body Count":"杀伤计数","Drifting Contact":"漂移接触","Corrupt Charge":"邪恶蓄力","Life Strike":"生命打击","Killing Blow":"一击必杀","Seismic Wave":"震波","Primed Fast Hands":"爆发装填 Prime","Fast Hands":"爆发装填","Quickdraw":"持续火力","Primed Quickdraw":"持续火力 Prime","Magazine Warp":"弹匣增幅","Primed Magazine Warp":"弹匣增幅 Prime","Ammo Stock":"霰弹扩充","Primed Ammo Stock":"霰弹扩充 Prime","Metal Auger":"合金钻头","Seeking Force":"穿透力","Seeker":"弹头导引","Rifle Ammo Mutation":"步枪弹药转换","Primed Rifle Ammo Mutation":"步枪弹药转换 Prime","Pistol Ammo Mutation":"手枪弹药转换","Primed Pistol Ammo Mutation":"手枪弹药转换 Prime","Sniper Ammo Mutation":"狙击枪弹药转换","Primed Sniper Ammo Mutation":"狙击枪弹药转换 Prime","Rupture":"破裂","Piercing Hit":"穿甲伤害","Piercing Caliber":"穿甲口径","Sawtooth Clip":"锯齿弹链","Fanged Fusillade":"尖牙连射","Crash Course":"连续冲击","Bore":"枪膛","Maim":"致残枪弹","Buzz Kill":"败兴虐杀","Jagged Edge":"锯刃","Heavy Trauma":"重创","Primed Heavy Trauma":"重创 Prime","Bane of Grineer":"灭亡Grineer","Primed Bane of Grineer":"灭亡 Grineer Prime","Bane of Corpus":"灭亡Corpus","Primed Bane of Corpus":"灭亡 Corpus Prime","Bane of Infested":"灭亡Infested","Primed Bane of Infested":"灭亡 Infested Prime","Smite Grineer":"毁灭 Grineer","Primed Smite Grineer":"毁灭 Grineer Prime","Smite Corpus":"毁灭 Corpus","Primed Smite Corpus":"毁灭 Corpus Prime","Smite Infested":"毁灭 Infested","Primed Smite Infested":"毁灭 Infested Prime","Primary Merciless":"主要·无情","Primary Deadhead":"主要·死首","Primary Dexterity":"主要·熟练","Secondary Merciless":"次要·无情","Secondary Deadhead":"次要·死首","Secondary Dexterity":"次要·熟练","Arcane Rage":"赋能·愤怒","Arcane Precision":"赋能·精确","Arcane Fury":"赋能·狂怒","Arcane Avenger":"赋能·复仇者","Arcane Velocity":"赋能·迅速","Arcane Acceleration":"赋能·加速","Arcane Strike":"赋能·速攻","Arcane Tempo":"赋能·节奏","Arcane Momentum":"赋能·动量","Arcane Awakening":"赋能·觉醒","Arcane Rise":"赋能·崛起","Arcane Blade Charger":"赋能·刀刃充能","Arcane Primary Charger":"赋能·主武充能","Arcane Pistoleer":"赋能·枪炮","Arcane Arachne":"赋能·蜘蛛","Arcane Crepuscular":"赋能·影袭","Melee Retaliation":"近战·报复","Melee Influence":"近战·侵染","Melee Duplicate":"近战·刃影","Melee Crescendo":"近战·渐强","Melee Exposure":"近战·暴露","Ready Steel":"磨砺锋刃","Champion's Blessing":"强者祝福","Biting Frost":"刺骨寒霜","Reinforced Bond":"强固连结","Tenacious Bond":"坚韧连结","Vigorous Swap":"强力切换","Galvanized Reflex":"镀层 增幅线圈","Reflex Coil":"增幅线圈","Blind Justice":"无明制裁","Tranquil Cleave":"秋风落叶","Decisive Judgement":"果断裁决","Iron Phoenix":"钢铁凤凰","Crimson Dervish":"赤红狂舞","Tempo Royale":"皇家节奏","Cleaving Whirlwind":"弧刃回天","Bullet Dance":"刀锋弹舞","High Noon":"正午","Exalted Blade":"显赫刀剑","Rifle Amp":"步枪增幅","Pistol Amp":"手枪增幅","Shotgun Amp":"霰弹枪增幅","Dead Eye":"死亡之眼","Steel Charge":"钢铁充能","Corrosive Projection":"腐蚀投射","Magnetic Capacity":"磁性弹容","Magnetic Rush":"励磁加速","Magnetic Strafe":"磁暴洗礼","Magnetic Might":"磁吸巨力","Magnetic Welt":"磁化冲击","Enduring Affliction":"长时苦难","Covert Lethality":"致命匿杀","Finishing Touch":"画龙点睛","Archon Continuity":"执刑官 持久力","Archon Vitality":"执刑官 生命力","Pain Points":"痛点","Dreadful Killshot":"恐怖杀戮","Amar's Contempt":"欺谋狼主之鄙","Boreal's Contempt":"诡文枭主之鄙","Burning Hate":"炽烈憎恨","Hunter's Bonesaw":"猎人骨锯","Nira's Contempt":"混沌蛇主之鄙","Sentient Surge":"Sentient 涌现","Double Tap":"双重连击","Spring-Loaded Broadhead":"簧压猎箭","Pistol Pestilence":"瘟疫手枪","Contagious Spread":"传染蔓延","Primed Chilling Grasp":"急冻控场 Prime","Toxic Blight":"毁坏毒素","Toxic Barrage":"毒素弹幕","Incendiary Coat":"燃烧外壳","Blaze":"烈焰","Scattering Inferno":"炼狱轰击","Scorch":"灼痕焦点","Chilling Grasp":"急冻控场","Chilling Reload":"激冷装填","Frigid Blast":"冰冷疾风","Frostbite":"结霜侵蚀","Ice Storm":"冰风暴","Charged Shell":"充电弹头","Primed Charged Shell":"充电弹头 Prime","Shell Shock":"电冲弹药","Jolt":"电流震击","Damzav-Vati":"剧毒射击","Deadly Maneuvers":"致命机动","Deadly Sequence":"致命数列","Exposing Harpoon":"暴露鱼叉","Hata-Satya":"真实击杀","Motus Setup":"跃动 设局","Proton Snap":"质子 猛扑","Merciless Gunfight":"无情枪斗","Unseen Dread":"潜隐恐惧","Laser Sight":"雷射瞄具","Shrapnel Shot":"破片射击","Sharpened Bullets":"尖锐子弹","Dreamer's Wrath":"梦者之怒","Primed Ravage":"破灭 Prime","Ravage":"破灭","Scattered Justice":"散射正义","Critical Mutation":"关键突变","Shrapnel Rounds":"破片弹头","Gilded Truth":"镀金真相","Accelerated Blast":"加速冲击","Shotgun Barrage":"霰弹弹幕","Amalgam Shotgun Barrage":"并合霰弹弹幕","Repeater Clip":"转轮弹匣","Spring-Loaded Chamber":"簧压膛室","Vigilante Supplies":"私法 补给","Amalgam Daikyu Target Acquired":"并合大久和弓锁定目标","Efficient Beams":"高效光束","Napalm Grenades":"凝固汽油榴弹","Entropy Burst":"熵数爆发","Eroding Blight":"侵蚀毁坏","Stockpiled Blight":"积存毁坏","Gleaming Blight":"毁坏微光","Justice Blades":"正义刀锋","Shattering Justice":"破碎正义","Acid Shells":"酸性弹药","Clip Delegation":"弹能过继","Bright Purity":"光明纯净","Winds of Purity":"纯净之风","Blade of Truth":"真相之刃","Stinging Truth":"过激真相","Dizzying Rounds":"晕眩弹药","Flux Overdrive":"通量步枪超载","Stunning Speed":"慑人神速","Precision Strike":"精准打击","Combat Reload":"战斗装填","Depleted Reload":"耗竭装填","Range Advantage":"优势距离","Eximus Advantage":"卓越者优势","Bhisaj-Bal":"治愈羽箭","Aero Agility":"空飞 灵巧","Emergent Aftermath":"紧急后果","Tactical Pump":"战术上膛","Primed Tactical Pump":"战术上膛 Prime","Trick Mag":"戏法增幅","Eagle Eye":"鹰眼","Burdened Magazine":"过载弹匣","Shell Compression":"压缩弹药","Guardian Derision":"奚落守护","Metamorphic Magazine":"异变弹匣","Target Acquired":"锁定目标","Primed Slip Magazine":"串联弹匣 Prime","Slip Magazine":"串联弹匣","Amalgam Javlok Magazine Warp":"并合燃焰标枪弹匣增幅","Zazvat-Kar":"无尽弹雨","Skull Shots":"头颅射击","Brain Storm":"头脑风暴","Lethal Momentum":"致命动量","Terminal Velocity":"极限速度","Fatal Acceleration":"致死加速","Focused Acceleration":"聚焦加速","Ammo Drum":"弹鼓","Bane Of The Murmur":"灭亡低语者","Primed Bane of The Murmur":"灭亡低语者 Prime","Primed Expel Corpus":"驱逐 Corpus Prime","Primed Expel Grineer":"驱逐 Grineer Prime","Expel Grineer":"驱逐 Grineer","Primed Expel Corrupted":"驱逐堕落者 Prime","Expel Infested":"驱逐 Infested","Expel The Murmur":"驱逐低语者","Primed Expel The Murmur":"驱逐低语者 Prime","Primed Expel Infested":"驱逐 Infested Prime","Primed Bane of Corrupted":"灭亡堕落者 Prime","Bane of Corrupted":"灭亡Orokin","Primed Smite Corrupted":"毁灭堕落者 Prime","Smite The Murmur":"毁灭低语者","Primed Smite The Murmur":"毁灭低语者 Prime","Primed Cleanse Corrupted":"净化堕落者 Prime","Cleanse Corrupted":"净化堕落者","Primed Cleanse Grineer":"净化 Grineer Prime","Cleanse Grineer":"净化 Grineer","Cleanse The Murmur":"净化低语者","Primed Cleanse Infested":"净化 Infested Prime","Cleanse Infested":"净化 Infested","Primed Cleanse Corpus":"净化 Corpus Prime","Cleanse Corpus":"净化 Corpus","Catalyzer Link":"触媒连动","Nano-Applicator":"纳米涂覆","Shotgun Savvy":"通晓霰弹枪","Embedded Catalyzer":"内置触媒","Spring-Loaded Blade":"簧压刀刃","Radiated Reload":"辐能装填","Atomic Fallout":"原子烟尘","Accelerated Isotope":"迅发核素","Focus Radon":"聚焦氡气","Leaded Gas":"毒气铅弹","Biotic Rounds":"生化弹药","Flechette":"箭型弹头","Breach Loader":"破裂填装","No Return":"有去无回","Jugulus Barbs":"喉骨刃者 倒刺","Jugulus Spines":"喉骨刃者 脊刺","Sundering Strike":"破甲","Auger Strike":"螺钻打击","Rending Strike":"撕裂打击","Disruptor":"冲击干扰","Full Contact":"全面接触","Pummel":"强力猛击","Concussion Rounds":"震荡弹头","Collision Force":"冲击巨力","Saxum Thorax":"重岩者 胸腔","Saxum Spittle":"重岩者 唾液","Shredder":"粉碎器","Sweeping Serration":"扫荡锯齿","Tainted Mag":"腐败弹匣","Tainted Clip":"感染弹匣","Razor Shot":"剃刀射击","Carnis Stinger":"肉碾虫 针刺","Sharpshooter":"神射手","Seeking Fury":"狂暴追猎","Power Throw":"奋力一掷","Charged Chamber":"蓄力装填","Primed Chamber":"膛室 Prime","Synth Charge":"合成 充能","Vigilante Offense":"私法 进攻","Carnis Mandible":"肉碾虫 巨颚","Continuous Misery":"无尽苦难","Lasting Sting":"未完之刺","Augur Seeker":"预言 探求","Hunter Track":"猎人 追踪","Perpetual Agony":"永恒苦痛","Lingering Torment":"恒久折磨","Primed Fulmination":"猛烈爆发 Prime","Primed Firestorm":"烈焰风暴 Prime","Galvanized Acceleration":"镀层 致死加速","Sinister Reach":"凶恶延伸","Stabilizer":"稳定","Counterbalance":"制衡","Steady Hands":"稳定枪手","Primed Steady Hands":"稳定枪手 Prime","Ruinous Extension":"毁灭扩展","Hush":"消音器","Suppress":"消音","Silent Battery":"寂静炮组","Volatile Quick Return":"易爆速返","Volatile Rebound":"易爆反弹","Quick Return":"快速收回","Rebound":"弹跳","Harkonar Scope":"哈库那瞄准镜","Combo Killer":"连击杀手","Whirlwind":"旋风","Hawk Eye":"隼目","Narrow Barrel":"狭窄枪膛","Healing Return":"治愈归复","Relentless Combination":"残酷组合","Nightwatch Napalm":"夜巡燃烧弹","Rubedo-Lined Barrel":"红晶枪管","Primed Rubedo-Lined Barrel":"红晶枪管 Prime","Primed Deadly Efficiency":"致命效率 Prime","Parallax Scope":"视差瞄具","Dual Rounds":"双重弹头","Primed Dual Rounds":"双重弹头 Prime","Critical Focus":"关键焦点","Hollowed Bullets":"中空子弹","Photon Overcharge":"光子过载","Necrophagic Vigor":"噬尸活力","Deadly Efficiency":"致命效率","Venomous Clip":"恶毒弹匣","Primed Venomous Clip":"恶毒弹匣 Prime","Polar Magazine":"极地弹仓","Combustion Rounds":"燃烧弹头","Primed Combustion Rounds":"燃烧弹头 Prime","Electrified Barrel":"带电枪管","Magnetized Cycle":"磁场循环","Magazine Extension":"扩充弹匣","Modified Munitions":"弹药改良","Quick Reload":"快速装填","Ammo Chain":"弹链","Ballista Measure":"弩炮测距","Automatic Trigger":"自动扳机","Shell Rush":"填弹加速","Archgun Ace":"曲翼枪械行家","Hypothermic Shell":"低温外壳","Contamination Casing":"毒染套管","Charged Bullets":"带电子弹","Magma Chamber":"熔岩弹膛","Sabot Rounds":"覆壳弹药","Containment Breach":"核控突破","Marked Target":"标记目标","Zodiac Shred":"黄道碎裂","Quasar Drill":"类星钻体","Comet Blast":"彗星爆发","Resolute Focus":"坚决专注","Shivering Contagion":"冷颤触染","Parry":"招架","Opportunity's Reach":"机遇所至","Mentor's Legacy":"师传秘技","Master's Edge":"宗师锐势","Focused Defense":"重点防御","Dispatch Overdrive":"超速击杀","Discipline's Merit":"纪律之功","Condition's Perfection":"极致境地","Defiled Snapdragon":"积秽骁龙","Crossing Snakes":"双蛇牙突","Swirling Tiger":"旋风虎击","Carving Mantis":"雕斩螳螂","Cyclone Kraken":"飓风海怪","Sundering Weave":"分裂编织","Vulpine Mask":"狡狐诈面","Wise Razor":"慧黠斩剃","Vengeful Revenant":"复仇亡灵","Swooping Falcon":"猎鹰俯击","Eleventh Storm":"终焉风暴","Final Harbinger":"最终先驱","Slicing Feathers":"割裂羽翼","Votive Onslaught":"埋首猛击","Homing Fang":"连牙追袭","Pointed Wind":"尖锐之风","Stinging Thorn":"螫刺狂棘","Seismic Palm":"震撼冲拳","Fracturing Wind":"破碎之风","Gaia's Tragedy":"母神悲歌","Grim Fury":"冷面狂怒","Brutal Tide":"残暴浪潮","Shimmering Blight":"飞光荒疫","Bleeding Willow":"血色万柳","Twirling Spire":"回转尖峰","Reaping Spiral":"收割螺旋","Stalking Fan":"缠旋风切","Clashing Forest":"巨林冲击","Flailing Branch":"多流抽击","Butcher's Revelry":"屠戮盛宴","Shattering Storm":"云暴山碎","Crushing Ruin":"月落乌啼","Rending Crane":"撕裂鹤击","Galeforce Dawn":"狂风压境","Astral Twilight":"星界微光","Gleaming Talon":"微光利爪","Atlantis Vulcan":"深渊之火","Gemini Cross":"纵横双子","Sovereign Outcast":"至尊浪人","Burning Wasp":"炙热黄蜂","Coiling Viper":"毒蛇螺旋","Malicious Raptor":"恶毒猛禽","Four Riders":"天启异象","Vermillion Storm":"朱红暴风","Ravenous Wraith":"贪婪怨灵","Gnashing Payara":"狼鱼咬咬","Spinning Needle":"旋压刺针","Sinking Talon":"沉没之爪","Hysteria":"狂化爆发","Serene Storm":"宁静风暴","Primal Fury":"原始狂怒","Mountain's Edge":"山之锋芒","Harrowing Spire":"胆寒尖刺","Blade Storm":"剑刃风暴","Razorwing":"剃刀之翼","Cascadia Overcharge":"瀑流·溢能","Cascadia Flare":"瀑流·耀炎","Secondary Encumber":"次要·妨害","Secondary Shiver":"次要·冷颤","Secondary Enervate":"次要·失活","Melee Doughty":"近战·无畏","Primary Frostbite":"主要·霜冻","Primary Debilitate":"主要·衰弱","Primary Bulwark":"主要·堡垒","Primary Overcharge":"主要·过载","Primary Crux":"主要·准星","Primary Plated Round":"主要·镀金弹头","Longbow Sharpshot":"弓箭·利矢","Fractalized Reset":"分形·重置","Shotgun Vendetta":"霰弹·仇杀","Primary Blight":"主要·毒侵","Melee Careen":"近战·疾驰","Melee Vortex":"近战·漩涡","Akimbo Slip Shot":"双枪·滑射","Secondary Outburst":"次要·爆发","Secondary Fortifier":"次要·筑垒","Secondary Irradiate":"次要·照射","Secondary Surge":"次要·激涌","Secondary Kinship":"次要·手足","Conjunction Voltage":"联结·电压","Worthy Comradery":"可靠战友","Holster Amp":"切换增幅","Swift Momentum":"迅敏动量","Mecha Empowered":"机甲 强化","Empowered Blades":"强化刀锋","Sentient Incision":"Sentient 切口","Reactive Storm":"响应风暴","Chromatic Blade":"华彩刀剑","Venom Dose":"猛毒附加","Shock Trooper":"电击奇兵","Freeze Force":"寒冰之力","Fireball Frenzy":"狂热火球","Thermal Transfer":"热能传递","Smite Infusion":"惩击洗礼","Enraged":"狂化震怒","Merulina Guardian":"涌浪之护","Gladiator Aegis":"角斗士 圣盾","Gladiator Resolve":"角斗士 决心","Gladiator Finesse":"角斗士 灵巧","Nira's Anguish":"混沌蛇主之苦","Nira's Hatred":"混沌蛇主之恨","Tek Collateral":"技法 连带","Vigilante Pursuit":"私法 追踪","Vigilante Vigor":"私法 活力","Smoke Shadow":"庇护烟幕","Cascadia Empowered":"瀑流·强化","Arcane Hot Shot":"赋能·热火","Primal Rage":"原始暴怒","+25% Critical Damage":"+25% 暴击伤害","+37.5% Critical Damage":"+37.5% 暴击伤害","+25% Status Chance":"+25% 异常状态触发几率","+37.5% Status Chance":"+37.5% 异常状态触发几率","+25% Critical Chance":"+25% 暴击几率的","+37.5% Critical Chance":"+37.5% 暴击几率的","+50% Critical Chance":"+50% 暴击几率","+75% Critical Chance":"+75% 暴击几率","+50% Critical Damage":"+50% 暴击伤害","+75% Critical Damage":"+75% 暴击伤害","Incr. max stacks of Corrosion +2":"腐蚀状态最大层数 +2","Incr. max stacks of Corrosion +3":"腐蚀状态最大层数 +3","Toxin Status +30% more damage":"毒素状态伤害 +30%","Toxin Status +45% more damage":"毒素状态伤害 +45%","+30% Primary Electricity Damage":"主武器电击伤害 +30%","+45% Primary Electricity Damage":"主武器电击伤害 +45%","+10% Ability Damage affected by Electricity":"电击状态下技能伤害 +10%","+15% Ability Damage affected by Electricity":"电击状态下技能伤害 +15%"},
  ...
  scaleEnemy(enemy, level, steelPath = false, eximus = false) {
    ...
    // 防御: 数据可能含 -1(缺失标记) 或字符串, 统一转非负数字
    // (如 Elite Ramsled/Narmer Deacon 的 armor/health=-1 → 按0处理)
    const baseHealth = Math.max(0, Number(enemy.health) || 0);
    const baseArmor = Math.max(0, Number(enemy.armor) || 0);
    const baseShield = Math.max(0, Number(enemy.shield) || 0);
    const baseOverguard = Math.max(0, Number(enemy.overguard) || 0);

    let finalArmor = baseArmor > 0
      ? Math.min(this.ARMOR_CAP, Math.floor(baseArmor * armorScale))
      : 0;
    let finalHealth = Math.floor(baseHealth * healthScale);
    let finalShield = Math.floor(baseShield * shieldScale);
    ...
    if (eximus) {
      ...
      finalArmor = Math.max(0, Math.floor(baseArmor * eximusArmorScale));
      
      const eximusHealthScale = this.enemyEximusHealth(level);
      finalHealth = Math.floor(baseHealth * eximusHealthScale);
      
      const eximusShieldScale = this.enemyEximusShields(level);
      finalShield = Math.floor(baseShield * eximusShieldScale);
    ...
    // 防御: overguard 也可能含 -1(缺失标记)
    const finalOverguard = baseOverguard > 0 ? Math.floor(baseOverguard * shieldScale) : 0;

    return { ...enemy, health: finalHealth, armor: finalArmor, shield: finalShield, overguard: finalOverguard, currentLevel: level };
  },
